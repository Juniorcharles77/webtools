    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-control" value="<?= $data->code->name ?>" required="required" />
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="code" name="code" class="form-control" required="required" value="<?= $data->code->code ?>" />
            </div>
