...
<div>
    <div class="form-group">
        ...
        <input type="text" name="from_name" class="form-control" value="<?= settings()->smtp->from_name ?>" />
    ...
    <div class="form-group">
        ...
        <input type="text" name="from" class="form-control" value="<?= settings()->smtp->from ?>" />
        <small class="form-text text-muted"><?= l('admin_settings.smtp.from_help') ?></small>
    </div>

    <div class="form-group">
        <label for="host"><?= l('admin_settings.smtp.host') ?></label>
        <input type="text" name="host" class="form-control" value="<?= settings()->smtp->host ?>" />
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="form-group">
                ...
                <input id="port" type="text" name="port" class="form-control" value="<?= settings()->smtp->port ?>" />
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <input id="username" type="text" name="username" class="form-control" value="<?= settings()->smtp->username ?>" />
    </div>

    <div class="form-group">
        <label for="password"><?= l('admin_settings.smtp.password') ?></label>
        <input id="password" type="password" name="password" class="form-control" value="<?= settings()->smtp->password ?>" />
    </div>
