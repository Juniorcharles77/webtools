...
<div class="table-responsive table-custom-container">
    <table class="table table-custom">
        ...
        <tr>
            ...
            <td class="text-nowrap">-</td>
            <td class="text-nowrap">
                <a href="<?= url('admin/users?plan_id=free') ?>" class="btn btn-link text-decoration-none">
        ...
        <tr>
            ...
            <td class="text-nowrap">-</td>
            <td class="text-nowrap">
                <a href="<?= url('admin/users?plan_id=custom') ?>" class="btn btn-link text-decoration-none">
                    <i class="fa fa-fw fa-users mr-1"></i>
        ...
        <?php foreach($data->plans as $row): ?>
            <tr data-plan-id="<?= $row->plan_id ?>">
                ...
                <td class="text-nowrap">
                    <a href="<?= url('admin/users?plan_id=' . $row->plan_id) ?>" class="btn btn-link text-decoration-none">
                        <i class="fa fa-fw fa-users mr-1"></i>
