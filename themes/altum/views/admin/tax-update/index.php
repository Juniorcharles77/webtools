    ...
    <div class="card-body">
        <form action="" method="post" role="form">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <select id="value_type" name="value_type" class="form-control" disabled="disabled">
            ...
            <div class="form-group">
                ...
                <select id="billing_type" name="billing_type" class="form-control" disabled="disabled">
            ...
            <div class="form-group">
                ...
                <select id="countries" name="countries[]" class="form-control" multiple="multiple" disabled="disabled">
