...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li class="active" aria-current="page"><?= l('tools.nibbles_to_yobibytes.name') ?></li>
        </ol>
    </nav>

    <div class="row mb-4">
        <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
            <h1 class="h4 m-0"><?= l('tools.nibbles_to_yobibytes.name') ?></h1>

            <div class="ml-2">
                <span data-toggle="tooltip" title="<?= l('tools.nibbles_to_yobibytes.description') ?>">
...
<script>
    ...
    let convert = () => {
        ...
        /* Calculate result */
        let result = nr(input * 4 / (8 * Math.pow(1024, 8)), precision);
