...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li class="active" aria-current="page"><?= l('tools.heic_to_png.name') ?></li>
        </ol>
    </nav>

    <div class="row mb-4">
        <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
            <h1 class="h4 m-0"><?= l('tools.heic_to_png.name') ?></h1>

            <div class="ml-2">
                <span data-toggle="tooltip" title="<?= l('tools.heic_to_png.description') ?>">
        ...
        <div class="card-body">
            ...
            <form action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="image" type="file" name="image" accept=".heic" class="form-control-file altum-file-input <?= \Altum\Alerts::has_field_errors('image') ? 'is-invalid' : null ?>" />
                    <?= \Altum\Alerts::output_field_error('image') ?>
                    <small class="form-text text-muted"><?= sprintf(l('global.accessibility.whitelisted_file_extensions'), '.heic') ?></small>
                </div>
...
<?php ob_start() ?>
<script src="<?= ASSETS_FULL_URL . 'js/libraries/heic2any.min.js' ?>"></script>
    ...
    let convert = () => {
        ...
        heic2any({
            ...
            .then(blob_result => {
                ...
                file_reader.readAsDataURL(blob_result);
