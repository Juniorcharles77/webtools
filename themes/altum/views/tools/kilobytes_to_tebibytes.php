...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li class="active" aria-current="page"><?= l('tools.kilobytes_to_tebibytes.name') ?></li>
        </ol>
    </nav>

    <div class="row mb-4">
        <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
            <h1 class="h4 m-0"><?= l('tools.kilobytes_to_tebibytes.name') ?></h1>

            <div class="ml-2">
                <span data-toggle="tooltip" title="<?= l('tools.kilobytes_to_tebibytes.description') ?>">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-between align-items-center">
                        <label for="result"><?= l('tools.tebibytes') ?></label>
                        <div>
                            <button
                                    type="button"
...
<script>
    ...
    let convert = () => {
        ...
        /* Calculate result */
        let result = nr(input * 1000 / Math.pow(1024, 4), precision);
